...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/HOME/OneDrive/Desktop/rekar-projects/esl-chatbot-web/frontend/node_modules/ufo/dist/index.mjs';
...
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file://C:/Users/HOME/OneDrive/Desktop/rekar-projects/esl-chatbot-web/frontend/node_modules/pathe/dist/index.mjs';
...
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/HOME/OneDrive/Desktop/rekar-projects/esl-chatbot-web/frontend/node_modules/ipx/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/Users/HOME/OneDrive/Desktop/rekar-projects/esl-chatbot-web/frontend/public"
      ]
    },
    "http": {
      "domains": []
...
const _4r3YJEcCB8rWF1n9J21Bu_peaGDyZs7l_9JZeBXxb8Q = (nitroApp) => {
...
_4r3YJEcCB8rWF1n9J21Bu_peaGDyZs7l_9JZeBXxb8Q
];
...
const _rHkHsy = lazyEventHandler(() => {
...
const _lazy_HL5Fci = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _PPzGtP, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_HL5Fci, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _rHkHsy, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HL5Fci, lazy: true, middleware: false, method: undefined }
];
