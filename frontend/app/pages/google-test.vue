<template>
  <div
    ...
    "
  >
    <h1 style="color: #fff; font-size: 1.2rem; margin-bottom: 4px">
      Google OAuth Test
    </h1>
    <span
      style="
    ...
    <div
      ...
      "
    >
      <strong style="color: #888">DEBUG — Client ID:</strong><br />
      <code style="color: #4ade80; word-break: break-all">
        {{ clientId || "NOT FOUND" }}
      </code>
    </div>
    ...
    >
      ...
      <a
        ...
        >Swagger UI</a
      >
      → <strong>POST /auth/google</strong> → paste the token
    </div>
    ...
    <div style="margin: 24px 0">
      <p
        ...
        "
      >
        Step 2 — Your ID token (copy into Swagger)
      </p>
      <textarea
    ...
    <div
      ...
      "
    >
      <strong>New user?</strong> First call returns
      <code
        style="
          background: #2a2a2a;
          padding: 2px 6px;
      ...
      to finish.<br />
      <em style="color: #888"
        >Tokens expire after 1 hour — refresh this page to get a new one.</em
      >
    </div>
  </div>
</template>
